  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050912] px-4 py-10">
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 20% 10%, rgba(52,211,153,0.16), transparent 25%), radial-gradient(circle at 80% 90%, rgba(59,130,246,0.2), transparent 30%), linear-gradient(rgba(59,130,246,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(59,130,246,0.06) 1px, transparent 1px)',
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-slate-700/60 bg-slate-900/90 p-8 shadow-2xl shadow-black/40 backdrop-blur">
        ...
        <div className="mt-8 border-t border-slate-700/60 pt-6 text-center">
          <p className="text-sm font-bold tracking-[0.25em] text-emerald-400">PROJECT4A</p>
          <p className="mt-2 text-[11px] leading-relaxed text-slate-400">
            <span className="font-medium text-emerald-300/90">A</span>ccurate{' '}
            <span className="text-slate-600">·</span>{' '}
            <span className="font-medium text-emerald-300/90">A</span>ccessible{' '}
            <span className="text-slate-600">·</span>{' '}
            <span className="font-medium text-emerald-300/90">A</span>ctive{' '}
            <span className="text-slate-600">·</span>{' '}
            <span className="font-medium text-emerald-300/90">A</span>utomated
          </p>
